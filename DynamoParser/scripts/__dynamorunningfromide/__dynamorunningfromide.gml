function __DynamoRunningFromIDE()
{
    ...
    {
        __DynamoTrace("Warning! Dynamo can only run in dev mode on Windows and MacOS. Development mode is disabled on this platform");
        return false;
    }
    else
    {
		...
		else if (os_type == os_macosx)
		{
		    ...
		    &&  (parameter_string(0) == "-game")
		    &&  (filename_ext(parameter_string(1)) == ".ios"))
		    {
		        return true;
		    }
		}
