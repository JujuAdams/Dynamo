...
function __DynamoBufferBatch() constructor
{
    __destroyed  = false;
    ...
    static GetString = function()
    {
        ...
        if (buffer_get_size(__outBuffer) <= 0) return "";
    ...
    static CopyFromBuffer = function(_buffer, _start = 0, _count = (buffer_get_size(_buffer) - _start))
    {
        ...
        __inBuffer = buffer_create(_buffer, buffer_grow, 1);
        buffer_copy(_buffer, _start, _count, __inBuffer, 0);
